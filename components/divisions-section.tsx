...
const divisions = [
  {
    ...
    description: "Automatically selects the smallest effective model for every request. Save up to 90% on compute.",
    visual: "routing",
  },
  {
    number: "02",
    title: "ACTIVE PRIVACY",
    description: "Sensitive information is detected and protected before any model access. Zero data exposure.",
    visual: "privacy",
  },
  {
    number: "03",
    title: "API INFRASTRUCTURE",
    description: "Enterprise-grade efficient AI deployment. One endpoint, every model, instant scaling.",
    visual: "api",
  },
  {
    number: "04",
    title: "MULTIMODAL CORE",
    description: "Unified processing across text, vision, and audio. Route any modality to optimal models.",
    visual: "multimodal",
  },
  {
    number: "05",
    title: "CONTEXT MEMORY",
    description: "Persistent knowledge graphs that remember. Long-term context across sessions.",
    visual: "memory",
  },
  {
    number: "06",
    title: "AUTONOMOUS SYSTEMS",
    description: "Persistent AI workflows that execute complex tasks. Set goals, let agents work.",
    visual: "agents",
  },
]
